...
This installs both:
- `fr` - The command-line tool
- `frontrange-mcp` - The MCP server

**Note**: This is a beta release. For production use, consider building from source or using Swift Package Manager.
